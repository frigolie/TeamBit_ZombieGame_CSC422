 ...
 */
/**
 * Team Project - ZombieGame Concordia St. Paul - CSC 422 Team Bit
 *
 ...
 */
/**
 * Displays info to user and turns user input into information the system can
 * use.
 */
public final class GameView {
    ...
    public void displayBattleInfo(BattleInfo battleInfo) {
        for (Fatality fatality : battleInfo) {
            ...
            // 
            String extraInfor = fatality.getExtraInfor();
            if (extraInfor == null) {
                // zombie case
                System.out.printf("%s killed %s\n", attacker, casualty);
            } else {
                // survivor case
                System.out.printf("%s killed %s with \n\t %s\n",
                        attacker, casualty, extraInfor);
            }
     ...
     *
     * @param survivorPartyInfo [numberOfChildren, numberOfTeachers,
     * numberOfSoldiers]
    ...
    /**
     * Prints a message about how many survivors remain after a battle is
     * completed.
     *
    ...
    /**
     * Asks player if they would like to play again. Loops until player enters
     * "y" or "n" (ignore case).
     *
